...
def fire_bullet(ai_settings, screen, ship, bullets):
    """Fire a bullet if a limit of allowed bullets in not reached yet"""
...
def update_bullets(ai_settings, screen, stats, sb, ship, aliens, bullets):
    ...
    for bullet in bullets.copy():
        # Use copy of the bullets Group/list since it
        # isn't advisable to modify a list in a for loop
        # while iterating over it
        if bullet.rect.bottom <= 0:
            bullets.remove(bullet)
    check_bullet_allien_collision(ai_settings, screen, stats, sb, ship, aliens, bullets)


def check_bullet_allien_collision(ai_settings, screen, stats, sb, ship, aliens, bullets):
...
def get_number_aliens(ai_settings, alien_width):
    """Determine the numer of aliens to fit in a row"""
...
def check_fleet_edges(ai_settings, aliens):
    """Give appropriate response if any of the aliens
